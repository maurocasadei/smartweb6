                ...
                if ($db->count > 0) {
                  ...
                  <div class="entry-header">
                    <div class="post-thumb thumb">
                      <img src="<?php echo $config["siteurl"].convertiimmagine($r["nw_immagine"],"big") ?>" alt="" class="img-responsive img-fullwidth">
                    </div>
                  </div>
                  <div class="entry-content p-20 pr-10">
                    ...
                    <p class="mt-10"><?php echo $r["nw_testo"] ?></p>
                    <p class="mt-10"><?php echo $r["nw_scadenza"] ?></p>
